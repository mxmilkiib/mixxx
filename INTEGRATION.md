...
```json
{
  ...
  "branches": [
    ...
    {"ref": "feature/2026.08aug.28-library-overview-minute-markers", "worktree": "2026.08aug.28-library-overview-minute-markers", "integrate": true, "gate": true, "dependencies": ["feature/2025.10oct.20-hotcues-on-overview-waveform"], "merge_order": 41},
...
- 🟡 **NEW FEATURES - Open PRs (REVIEW_REQUIRED)**
  ...
  - [x] **feature/2026.08aug.28-library-overview-minute-markers** — No PR yet
    - Created: 2026-08-28, Updated: 2026-08-28
    - Next: Open upstream PR
    - Specifics:
