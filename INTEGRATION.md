...
```json
{
  ...
  "branches": [
    ...
    {"ref": "feature/2025.10oct.21-replace-libmodplug-with-libopenmpt", "worktree": "2025.10oct.21-replace-libmodplug-with-libopenmpt", "integrate": true, "gate": true, "merge_order": 60, "pr": 16921},
    ...
    {"ref": "feature/2026.08aug.22-library-waveform-uniform-time-base", "worktree": "2026.08aug.22-library-waveform-uniform-time-base", "integrate": true, "gate": true, "merge_order": 210}
  ],
  "test_exclusions": [
...
| `--quick-integration` | Rebase, transactional remerge, and build only the combined integration tree; skip local tests and all remote operations (push, CI, promotion). Use for fast iteration when one only needs a runnable integration binary |
...
**Summary** (verified 2026-08-22; each branch counted once): 7 changes-addressed · 7 review-required · 1 changes-requested-open · 2 schema-excluded · 3 local-only/abandoned/archived · 3 personal-only · 2 secondary patches · 10 merged/resolved upstream · 0 untracked WIP worktree
...
- 🔵 **Local Only (No PR)**
  ...
  - [x] **feature/2026.08aug.22-library-waveform-uniform-time-base** — LOCAL_ONLY
    - Created: 2026-08-22, Updated: 2026-08-22
    - Commit: uncommitted — add uniform time base option for library overview waveforms (7 files, 204 insertions / 14 deletions across `overviewcache.cpp/.h`, `overviewdelegate.cpp/.h`, `dlgprefwaveform.cpp/.h`, `dlgprefwaveformdlg.ui`)
    ...
    - Next: Commit, test with real library, decide whether to open an upstream PR
